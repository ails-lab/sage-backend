...
//@TypeAlias("graphdb")
public class GraphDBConfiguration extends TripleStoreConfiguration {
	...
	private String getSparqlUpdateEndpoint() {
    ...
    public void executePrepareLoadStatement(String folder, String file, String graph, String fileSystemDataFolder) throws Exception {
		...
		UpdateProcessor up = UpdateExecutionFactory.createRemote(UpdateFactory.create(sparql), getSparqlUpdateEndpoint());
		up.execute();
    ...
    public void executeSparqlUpdateStatement(String stmt) throws Exception {
		UpdateProcessor up = UpdateExecutionFactory.createRemote(UpdateFactory.create(stmt, Syntax.syntaxSPARQL_11), getSparqlUpdateEndpoint());
		up.execute();
	}
	...
	public TripleStoreType getType() {
		return TripleStoreType.GRAPHDB;
	}
