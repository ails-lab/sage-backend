...
public class SOAVocabulary extends Vocabulary {
    ...
    public static Property onGraphTree = model.createProperty(SOA_NAMESPACE + "onGraphTree");
    public static Property onValue = model.createProperty(SOA_NAMESPACE + "onValue");
    public static Property onBinding = model.createProperty(SOA_NAMESPACE + "onBinding");
    public static Property value = model.createProperty(SOA_NAMESPACE + "value");
    public static Property variable = model.createProperty(SOA_NAMESPACE + "variable");
    ...
    public static Property hasBodyStatement = model.createProperty(SOA_NAMESPACE + "hasBodyStatement");
