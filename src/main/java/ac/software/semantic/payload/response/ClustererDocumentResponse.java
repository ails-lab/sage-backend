...
public class ClustererDocumentResponse implements Response, ExecutePublishResponse, MultiUserResponse {
...
//   private String asProperty;
   ...
   private String clustererId;
   private String clustererName; // name for annotatorId
...
//   private PrefixizedUri defaultTarget;
   ...
   public ClustererDocumentResponse() {
   }
